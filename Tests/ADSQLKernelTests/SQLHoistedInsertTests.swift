...
struct SQLHoistedInsertTests {
    ...
    @Test func hoistedMatchesStandardAndSQLite() throws {
        ...
        try Self.apply(
            "INSERT OR REPLACE INTO t(id, k, framework, score) VALUES(1, 'k1', 'metal', 9)",
            std, hoi, m)
        try Self.apply(
            "INSERT OR REPLACE INTO t(k, framework, score) VALUES('k2', 'uikit', 3)",
            std, hoi, m)
